...
export function TableBlock({ rows, cellStyles, columnWidths: initialColumnWidths, rowHeights: initialRowHeights, onChange }: TableBlockProps) {
  ...
  const commitDimensions = useCallback(
    ...
    [cellStyles, normalizedCellStyles, normalizedRows, onChange],
  )
  ...
  const gridTemplateRows = Array.from({ length: normalizedRows.length }, (_, index) =>
    rowHeights[index] && rowHeights[index] > 0 ? `${rowHeights[index]}px` : 'minmax(39px, auto)',
  ).join(' ')
    ...
    <div className="table-block">
      <div className="table-scroll">
        <div className="table-stage">
          ...
          <div className="table-column-controls" style={{ gridTemplateColumns } as CSSProperties}>
            {Array.from({ length: columnCount }, (_, cellIndex) => (
              ...
              >
                <button
                  type="button"
                  className="table-control-trigger"
